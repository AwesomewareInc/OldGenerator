...
public class ChunkProviderGenerate173 implements OldChunkGenerator {
    ...
    public ChunkProviderGenerate173(World world, long seed, List<BlockPopulator> populators) {
        this.world = world;
                    ...
                    for (int l1 = 0; l1 < 8; ++l1) {
                        ...
                        for (int i2 = 0; i2 < 4; ++i2) {
                            ...
                            for (int k2 = 0; k2 < 4; ++k2) {
                                ...
                                LegacyUtil173.setBlockData(chunkData, j2, blockData, !(k1 >= 0));
                                j2 += short1;
                                d15 += d16;
                            }
    ...
    public void generateBiomeTerrain(int chunkX, int chunkZ, ChunkGenerator.ChunkData chunkData,
        ...
        this.sandNoise = this.sandAndGravelNoiseGenerator.generateNoise(this.sandNoise, (double) (chunkX * 16),
        ...
        this.stoneNoise = this.stoneNoiseGenerator.generateNoise(this.stoneNoise, (double) (chunkX * 16),
        ...
        for (int k = 0; k < 16; ++k) {
            for (int l = 0; l < 16; ++l) {
                ...
                for (int k1 = 127; k1 >= -64; --k1) {
                    ...
                    if (k1 <= -64 + this.random.nextInt(5)) {
                        LegacyUtil173.setBlockData(chunkData, l1, BlockConstants.BEDROCK, true);
                    } else {
                        ...
                        if (BlockConstants.isAir(b3)) {
                            ...
                            if (j1 == -1) {
                                ...
                                } else if (k1 >= water_level - 4 && k1 <= water_level + 1) {
                                    b1 = biomebase.top;
                                    b2 = biomebase.bottom;
                                    if (flag1) {
                                        b1 = BlockConstants.AIR;
                                ...
                                if (k1 < water_level && b1 == BlockConstants.AIR) {
                                    b1 = BlockConstants.SOURCE_WATER;
                                }

                                j1 = i1;
                                if (k1 >= water_level - 1) {
                                    LegacyUtil173.setBlockData(chunkData, l1, b1, !(k1 >= 0));
                                } else {
                                    LegacyUtil173.setBlockData(chunkData, l1, b2, !(k1 >= 0));
                                }
                            } else if (j1 > 0) {
                                --j1;
                                LegacyUtil173.setBlockData(chunkData, l1, b2, !(k1 >= 0));
    ...
    private double[] generateTerrainNoise(double[] noise, int fromX, int fromY, int fromZ, int xLen, int yLen,
            int zLen) {
        if (noise == null) {
        ...
        this.terrainNoise4 = this.terrainNoise4Generator.generateNoise(this.terrainNoise4, fromX, fromZ, xLen, zLen,
                1.121D, 1.121D, 0.5D);
        this.terrainNoise5 = this.terrainNoise5Generator.generateNoise(this.terrainNoise5, fromX, fromZ, xLen, zLen,
                200.0D, 200.0D, 0.5D);
        this.terrainNoise1 = this.terrainNoise1Generator.generateNoise(this.terrainNoise1, (double) fromX,
                (double) fromY, (double) fromZ, xLen, yLen, zLen, d0 / 80.0D, d1 / 160.0D, d0 / 80.0D);
        this.terrainNoise2 = this.terrainNoise2Generator.generateNoise(this.terrainNoise2, (double) fromX,
                (double) fromY, (double) fromZ, xLen, yLen, zLen, d0, d1, d0);
        this.terrainNoise3 = this.terrainNoise3Generator.generateNoise(this.terrainNoise3, (double) fromX,
                (double) fromY, (double) fromZ, xLen, yLen, zLen, d0, d1, d0);
        int k1 = 0;
        int l1 = 0;
        int i2 = 16 / xLen;
    ...
    public void generateUnpopulatedChunkData(ChunkGenerator.ChunkData chunkData, int chunkX, int chunkZ,
        ...
        this.biomeNoiseCache = this.worldChunkManager.getBiomeNoise(this.biomeNoiseCache, chunkX * 16, chunkZ * 16, 16,
                16);
        for (int z = 0; z <= 15; ++z) {
            for (int x = 0; x <= 15; ++x) {
    ...
    public void populateChunk(BlockAccess blockAccess, int chunkX, int chunkZ) {
        ...
        this.random.setSeed((long) chunkX * i1 + (long) chunkZ * j1 ^
                this.world.getSeed());
        double d0 = 0.25D;
        int k1;
        int l1;
        ...
        if (this.random.nextInt(4) == 0) {
            ...
            (new WorldGenLakes173(BlockConstants.SOURCE_WATER)).populate(blockAccess,
                    this.random, k1, l1, i2);
        }
        ...
        if (this.random.nextInt(8) == 0) {
            ...
            if (l1 < 64 || this.random.nextInt(10) == 0) {
                (new WorldGenLakes173(BlockConstants.SOURCE_LAVA)).populate(blockAccess,
                        this.random, k1, l1, i2);
            }
        }
        ...
        for (k1 = 0; k1 < 20; ++k1) {
            ...
            i2 = this.random.nextInt(128);
            j2 = l + this.random.nextInt(16);
            (new WorldGenMinable173(BlockConstants.DIRT, 32)).populate(blockAccess,
                    this.random, l1, i2, j2);
        }
        ...
        for (k1 = 0; k1 < 10; ++k1) {
            ...
            i2 = this.random.nextInt(128);
            j2 = l + this.random.nextInt(16);
            (new WorldGenMinable173(BlockConstants.GRAVEL, 32)).populate(blockAccess,
                    this.random, l1, i2, j2);
        }
        ...
        for (k1 = 0; k1 < 20; ++k1) {
            ...
            i2 = this.random.nextInt(128);
            j2 = l + this.random.nextInt(16);
            (new WorldGenMinable173(BlockConstants.COAL_ORE, 16)).populate(blockAccess,
                    this.random, l1, i2, j2);
        }
        ...
        for (k1 = 0; k1 < 20; ++k1) {
            ...
            j2 = l + this.random.nextInt(16);
            (new WorldGenMinable173(BlockConstants.IRON_ORE, 8)).populate(blockAccess,
                    this.random, l1, i2, j2);
        }
        ...
        for (k1 = 0; k1 < 2; ++k1) {
            ...
            j2 = l + this.random.nextInt(16);
            (new WorldGenMinable173(BlockConstants.GOLD_ORE, 8)).populate(blockAccess,
                    this.random, l1, i2, j2);
        }
        ...
        for (k1 = 0; k1 < 8; ++k1) {
            ...
            j2 = l + this.random.nextInt(16);
            (new WorldGenMinable173(BlockConstants.REDSTONE_ORE,
                    7)).populate(blockAccess, this.random, l1, i2, j2);
        }
        ...
        for (k1 = 0; k1 < 1; ++k1) {
            ...
            i2 = this.random.nextInt(16);
            j2 = l + this.random.nextInt(16);
            (new WorldGenMinable173(BlockConstants.DIAMOND_ORE, 7)).populate(blockAccess,
                    this.random, l1, i2, j2);
        }
        ...
        for (k1 = 0; k1 < 1; ++k1) {
            ...
            j2 = l + this.random.nextInt(16);
            (new WorldGenMinable173(BlockConstants.LAPIS_ORE, 6)).populate(blockAccess,
                    this.random, l1, i2, j2);
        }
        ...
        d0 = 0.5D;
        k1 = (int) ((this.treeCountNoise.generateNoiseForCoordinate((double) k * d0,
                (double) l * d0) / 8.0D
        ...
        for (i2 = 0; i2 < l1; ++i2) {
            ...
            worldgenerator.populate(blockAccess, this.random, j2,
                    LegacyUtil173.getHighestBlockYAt(this.world, j2, k2),
                    k2);
        }
        ...
        for (j2 = 0; j2 < b0; ++j2) {
            ...
            (new WorldGenFlowers173(BlockConstants.DANDELION)).populate(blockAccess,
                    this.random, k2, i3, l2);
        }
        ...
        for (k2 = 0; k2 < b1; ++k2) {
            ...
            (new WorldGenDeadBush173(BlockConstants.DEAD_BUSH)).populate(blockAccess,
                    this.random, i3, l2, k3);
        }
        ...
        if (this.random.nextInt(2) == 0) {
            ...
            i3 = this.random.nextInt(128);
            l2 = l + this.random.nextInt(16) + 8;
            (new WorldGenFlowers173(BlockConstants.POPPY)).populate(blockAccess,
                    this.random, k2, i3, l2);
        }
        ...
        if (this.random.nextInt(4) == 0) {
            ...
            i3 = this.random.nextInt(128);
            l2 = l + this.random.nextInt(16) + 8;
            (new WorldGenFlowers173(BlockConstants.BROWN_MUSHROOM)).populate(blockAccess,
                    this.random, k2, i3, l2);
        }
        ...
        if (this.random.nextInt(8) == 0) {
            ...
            i3 = this.random.nextInt(128);
            l2 = l + this.random.nextInt(16) + 8;
            (new WorldGenFlowers173(BlockConstants.RED_MUSHROOM)).populate(blockAccess,
                    this.random, k2, i3, l2);
        }
        ...
        for (i3 = 0; i3 < 50; ++i3) {
            ...
            j3 = l + this.random.nextInt(16) + 8;
            (new WorldGenLiquids173(BlockConstants.SOURCE_WATER)).populate(blockAccess,
                    this.random, l2, k3, j3);
        }

        for (i3 = 0; i3 < 20; ++i3) {
            l2 = k + this.random.nextInt(16) + 8;
            k3 = this.random.nextInt(this.random.nextInt(this.random.nextInt(112) + 8) +
                    8);
            j3 = l + this.random.nextInt(16) + 8;
            (new WorldGenLiquids173(BlockConstants.SOURCE_LAVA)).populate(blockAccess,
                    this.random, l2, k3, j3);
        }

        this.snowNoise = this.worldChunkManager.createNoise(this.snowNoise, k + 8, l
                + 8, 16, 16);
        ...
        for (i3 = k + 8; i3 < k + 8 + 16; ++i3) {
            for (l2 = l + 8; l2 < l + 8 + 16; ++l2) {
                k3 = i3 - (k + 8);
                j3 = l2 - (l + 8);
                int l3 = this.world.getHighestBlockYAt(i3, l2, HeightMap.MOTION_BLOCKING) +
                        1; // TODO - make sure
                           // spigot doesn't break
                           // this again // TODO
                           // make sure this is the
                           // heightmap we want on
                           // update
                double d1 = this.snowNoise[k3 * 16 + j3] - (double) (l3 - 64) / 64.0D * 0.3D;

                Material below;

                if (d1 < 0.5D && l3 > 0 && l3 < 128 && blockAccess.getType(i3, l3,
                        l2).isAir()
                        && LegacyUtil173.Material_isSolid((below = blockAccess.getType(i3, l3 - 1,
                                l2)))
                        && below != Material.ICE) {
                    blockAccess.setBlockData(i3, l3, l2, BlockConstants.SNOW, false);
                    if (below == Material.GRASS_BLOCK) {
                        blockAccess.setBlockData(i3, l3 - 1, l2, BlockConstants.SNOWY_GRASS_BLOCK,
                                false);
                    }
                }
            }
